...
#crossn
class FOWHx080newPacket(Packet):
    
    IDENTIFIER = "Fineoffset-WHx080"

#rtl433_weewx | Sep 22 20:51:40 a775a68c0ed5 weewx[8] DEBUG user.sdr: lines=['{
# "time" : "2020-09-22 20:51:36", 
# "model" : "Fineoffset-WHx080", 
# "subtype" : 0, 
# "id" : 125, 
# "battery_ok" : 0, 
# "temperature_C" : 16.200, 
# "humidity" : 87, 
# "wind_dir_deg" : 315, 
# "wind_avg_km_h" : 4.896, 
# "wind_max_km_h" : 11.016, 
# "rain_mm" : 446.700, 
# "mic" : "CRC"}

# pressure is taken from the display
    ...
    def parse_json(obj):
        ...
        #pkt['subtype'] = Packet.get_int(obj, 'subtype')
        #pkt['mic'] = obj.get('mic')
        return FOWHx080newPacket.insert_ids(pkt)

    @staticmethod
    def insert_ids(pkt):
        station_id = pkt.pop('station_id', '0000')
        return Packet.add_identifiers(pkt, station_id, FOWHx080newPacket.__name__)
